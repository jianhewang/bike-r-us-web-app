...
The `Program` class in the `Program.cs` file will have to be replaced with the following. This new code will **seed the **database**** with our existing employees as users that can now log in.
